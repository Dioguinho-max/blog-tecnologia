...
function showSession(session) { form.hidden = true; modeButton.hidden = true; document.querySelector("#google-login").hidden = true; document.querySelector(".oauth-separator").hidden = true; document.querySelector("#account-user").hidden = false; document.querySelector("#account-email").textContent = session.user.email; document.querySelector("#account-avatar").src = session.user.user_metadata?.avatar_url || "https://ui-avatars.com/api/?name=" + encodeURIComponent(session.user.email); }
